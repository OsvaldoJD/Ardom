<fieldset>
    <div class="form-group">
        <label for="codigo_pessoas">Codigo *</label>
          <input type="text" name="codigo_pessoas" value="<?php echo $edit ? $pessoas['idPessoa'] : ''; ?>" placeholder=" Código do Produto (Ex: 0001P)" class="form-control" required="required" id = "codigo_pessoas" >
    </div> 
	...
	<div class="form-group">
        ...
        <input type="text" name="pai" value="<?php echo $edit ? $pessoas['mae'] : ''; ?>" placeholder="Nome do Produto" class="form-control" required="required" id="mae">
    </div>
	  <div class="form-group">
        ...
        <input name="dataNascimento" value="<?php echo $edit ? $pessoas['telefone'] : ''; ?>"  placeholder="Data Inicio da Promoção" class="form-control"  type="text">
    </div>
