...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    ...
    $db = getDbInstance();
    $last_id = $db->insert ('empresa', $data_to_store);
...
<div class="row">
     <div class="col-lg-12">
            <h2 class="page-header"><i class='glyphicon glyphicon-edit'></i> Nova Hospital</h2>
        </div>
        
</div>
    <form class="form" action="" method="post"  id="empresa_form" enctype="multipart/form-data">
       <?php  include_once('./forms/empresa_form.php'); ?>
    </form>
</div>
